...
export class PointCloudMaterial extends RawShaderMaterial {
  ...
  clipBoxes: IClipBox[] = [];
  visibleNodesTexture: Texture | undefined = undefined;
  ...
  uniforms: IPointCloudMaterialUniforms & Record<string, IUniform<any>> = {
    ...
    opacityAttenuation: makeUniform('f', 5),
  ...
  updateShaderSource(): void {
	...
	if (this.clipMode ===  ClipMode.HIGHLIGHT_INSIDE) {
		this.blending = CustomBlending;
		this.blendEquation = AddEquation; //default
		this.blendSrc = SrcAlphaFactor; //default
		this.blendDst = OneMinusSrcAlphaFactor; //default
